...
const SPECS: PlanSpec[] = [
  ...
  { planKey: 'Bundle·LP',envVar: 'STRIPE_PRICE_BUNDLE_LP',   name: 'Truos Sales Bundle — All 4 Credentials', description: 'Lifetime access to all four base courses (AI·101–104). Sales-page exclusive offer.', amountCents: 49500, mode: 'one_time' },
