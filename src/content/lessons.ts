  ...
  "102-0-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Prompt: \"Write a case study for our website.\" Which ICEF element, if added, most improves the output?",
        "options": [
          {
            "text": "A louder tone.",
            "correct": false,
  ...
  "102-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want tough feedback on a pitch deck. Which role sets up the best feedback?",
        "options": [
          {
  ...
  "102-0-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're teaching the AI your brand voice. Which set of examples works best?",
        "options": [
          {
  ...
  "102-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want a list of 10 target accounts to evaluate. Which format request is clearest?",
        "options": [
          {
  ...
  "102-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need a 500-word blog post arguing for investing in sales training. Best prompt?",
        "options": [
          {
  ...
  "102-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You pasted a 600-word memo and want it punchier. Best edit instruction?",
        "options": [
          {
  ...
  "102-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want a draft to sound more like a peer and less like a press release. Best instruction?",
        "options": [
          {
            "text": "\"Make it cooler.\"",
            "correct": false,
  ...
  "102-1-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've drafted a LinkedIn post with AI and want it to sound like you. Best next move?",
        "options": [
          {
  ...
  "102-2-0": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Search or AI?",
        "scenario": "You need to know your company's current PTO policy. Best first stop?",
        "options": [
          {
  ...
  "102-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "AI tells you \"the SaaS industry grew 12% in 2025.\" You want to cite it. Best verification move?",
        "options": [
          {
  ...
  "102-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've pasted three articles on AI adoption. Best follow-up?",
        "options": [
          {
            "text": "\"Summarize each.\"",
            "correct": false,
  ...
  "102-2-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "AI gives you a paragraph with: (a) general explanation of market dynamics, (b) a specific stat attributed to Gartner, (c) a general recommendation. What needs the most verification?",
        "options": [
          {
  ...
  "102-3-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which meeting summary format is most actionable for next week?",
        "options": [
          {
  ...
  "102-3-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "After a meeting, which prompt pulls the most useful action items?",
        "options": [
          {
  ...
  "102-3-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've written a technical spec; your CEO needs to understand the ask. Best prompt?",
        "options": [
          {
  ...
  "102-3-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What gets the AI closest to sounding like you in email?",
        "options": [
          {
  ...
  "102-4-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want a formula to count renewals in Q1. Best ask?",
        "options": [
          {
  ...
  "102-4-1": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Cleaning ask",
        "scenario": "You have a 5,000-row CSV of leads. Best cleaning move with AI?",
        "options": [
          {
  ...
  "102-4-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've pasted a revenue-by-segment table. Best follow-up?",
        "options": [
          {
  ...
  "102-4-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "AI tells you the average deal size is $42,300 across 12 deals. What do you do?",
        "options": [
          {
  ...
  "102-5-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your AI draft is \"fine but bland.\" Best follow-up?",
        "options": [
          {
  ...
  "102-5-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need a polished 2-page proposal. Best prompt strategy?",
        "options": [
          {
  ...
  "102-5-2": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Stuck or not?",
        "scenario": "You've iterated 4 times and each version is worse. What do you do?",
        "options": [
          {
            "text": "Give up.",
            "correct": false,
  ...
  "102-5-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're about to ask AI for something that really matters. What's the fastest upgrade you can make to a vague prompt?",
        "options": [
          {
            "text": "Add politeness.",
            "correct": false,
  ...
  "103-0-0": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Research use",
        "scenario": "AI gives you a specific claim: \"Your prospect led the Acme acquisition in Q3.\" What do you do?",
        "options": [
          {
            "text": "Ask the AI if it's sure.",
            "correct": false,
  ...
  "103-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which is the most useful prep output AI can give you before a disco call?",
        "options": [
          {
  ...
  "103-0-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Prospect says \"Your price is too high.\" Best prep prompt?",
        "options": [
          {
  ...
  "103-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "A prospect said \"let me check internally\" two weeks ago and went silent. Best follow-up?",
        "options": [
          {
  ...
  "103-0-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want AI to help maintain your CRM. Safest option?",
        "options": [
          {
  ...
  "103-0-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which task should never be fully AI-driven in sales?",
        "options": [
          {
  ...
  "103-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which campaign brief prompt produces the most useful output?",
        "options": [
          {
  ...
  "103-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're writing Facebook ad headlines. Best AI strategy?",
        "options": [
          {
  ...
  "103-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Best way to teach AI your brand voice?",
        "options": [
          {
  ...
  "103-1-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which competitive scan question produces the most useful answer?",
        "options": [
          {
            "text": "\"Are we better?\"",
            "correct": false,
  ...
  "103-1-4": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Retro prompt",
        "scenario": "Best quarterly retro prompt?",
        "options": [
          {
  ...
  "103-2-0": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "QBR focus",
        "scenario": "The first thing in every QBR should be:",
        "options": [
          {
  ...
  "103-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's most useful about an AI-assisted health score?",
        "options": [
          {
  ...
  "103-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the most common renewal-email mistake AI enables?",
        "options": [
          {
  ...
  "103-2-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're delivering a 12% price increase. Best prep?",
        "options": [
          {
  ...
  "103-2-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "During an escalation, what's the first AI task?",
        "options": [
          {
  ...
  "103-3-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've generated a process map with AI. What next?",
        "options": [
          {
            "text": "File it.",
            "correct": false,
  ...
  "103-3-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which is the best automation candidate?",
        "options": [
          {
  ...
  "103-3-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which risk item is most actionable?",
        "options": [
          {
  ...
  "103-3-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "In a weekly status update, where should \"at risk\" items go?",
        "options": [
          {
  ...
  "103-3-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "When is the highest-leverage moment to document a process?",
        "options": [
          {
  ...
  "103-4-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's AI's right role in contract review?",
        "options": [
          {
  ...
  "103-4-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "AI writes \"Revenue dropped 8% due to seasonal softness in Q4.\" You don't actually know the cause. What do you do?",
        "options": [
          {
  ...
  "103-4-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Two chatbots disagree on whether your expense is reimbursable. What do you do?",
        "options": [
          {
  ...
  "103-4-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "A vendor emails you asking you to wire payment to a new account. What do you do?",
        "options": [
          {
  ...
  "103-4-4": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "AI + legal",
        "scenario": "You're about to sign a vendor contract. How should AI be involved?",
        "options": [
          {
  ...
  "103-5-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which is most OK to paste into a public chatbot?",
        "options": [
          {
  ...
  "103-5-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want AI to help draft a tough customer email. What's the safest move?",
        "options": [
          {
  ...
  "103-5-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're about to paste a draft product roadmap into a public chatbot for writing help. What do you do?",
        "options": [
          {
  ...
  "103-5-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your company-approved Copilot can't do the task you need. What next?",
        "options": [
          {
  ...
  "103-5-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You just realized you pasted a confidential contract into a public chatbot. What's the first action?",
        "options": [
          {
  ...
  "103-5-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which pattern recurs across every AI·103 module?",
        "options": [
          {
  ...
  "104-0-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which workflow is the best AI-capstone candidate?",
        "options": [
          {
  ...
  "104-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which impact framing is most useful to a skeptical sponsor?",
        "options": [
          {
  ...
  "104-0-2": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Best wedge",
        "scenario": "Which is the better capstone wedge?",
        "options": [
          {
  ...
  "104-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the most common stakeholder mistake in AI capstone projects?",
        "options": [
          {
  ...
  "104-0-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "A stakeholder says \"while we're at it, could it also handle Y?\" What's the right response?",
        "options": [
          {
            "text": "Ignore them.",
            "correct": false,
  ...
  "104-0-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which is the clearest red flag?",
        "options": [
          {
  ...
  "104-0-6": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Why circulate the capstone brief before building?",
        "options": [
          {
            "text": "Because it's required.",
            "correct": false,
  ...
  "104-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "For a v1 workflow that turns meeting transcripts into CRM updates, best interface?",
        "options": [
          {
  ...
  "104-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your AI generates customer-facing emails. Best HITL pattern?",
        "options": [
          {
  ...
  "104-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You changed the prompt. What do you do before shipping the new version?",
        "options": [
          {
  ...
  "104-1-3": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Cost driver",
        "scenario": "Which cost driver is most often underestimated?",
        "options": [
          {
            "text": "Latency.",
            "correct": false,
  ...
  "104-1-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the right moment to write the spec?",
        "options": [
          {
  ...
  "104-1-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your AI workflow occasionally times out. Best fallback?",
        "options": [
          {
            "text": "Crash silently.",
            "correct": false,
  ...
  "104-1-6": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "No feedback by the deadline. What do you do?",
        "options": [
          {
  ...
  "104-2-0": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Right tool",
        "scenario": "Best tool choice for a v1 capstone?",
        "options": [
          {
  ...
  "104-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You improved your prompt and quality's up 15%. What do you do?",
        "options": [
          {
  ...
  "104-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Why test with real historical data instead of synthetic examples?",
        "options": [
          {
  ...
  "104-2-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You changed 5 things in the prompt at once. Evals improved. What now?",
        "options": [
          {
  ...
  "104-2-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're getting 200 alerts/day from your workflow. What do you do?",
        "options": [
          {
  ...
  "104-2-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's a simple mitigation for prompt injection?",
        "options": [
          {
  ...
  "104-2-6": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your workflow works in tests but feels awkward when you use it. What do you do?",
        "options": [
          {
  ...
  "104-3-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Best sequence for rolling out a new AI workflow?",
        "options": [
          {
  ...
  "104-3-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the most effective training format?",
        "options": [
          {
  ...
  "104-3-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the single most-read section of an SOP?",
        "options": [
          {
  ...
  "104-3-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Reach is growing but depth is flat — each user tries it once and stops. What does that signal?",
        "options": [
          {
  ...
  "104-3-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "A skeptic says \"I've tried it; my way is faster.\" What's the best move?",
        "options": [
          {
            "text": "Force-adopt it.",
            "correct": false,
  ...
  "104-3-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What should the 10-minute standup focus on?",
        "options": [
          {
  ...
  "104-4-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Why set quality thresholds that trigger a review?",
        "options": [
          {
            "text": "For audit.",
            "correct": false,
  ...
  "104-4-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which iteration pace is most sustainable?",
        "options": [
          {
  ...
  "104-4-2": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Vendor risk",
        "scenario": "Your AI model gets deprecated. What determines your response speed?",
        "options": [
          {
  ...
  "104-4-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your team wants to make one step fully autonomous. What's the first question?",
        "options": [
          {
  ...
  "104-4-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "When is the right time to deprecate a workflow?",
        "options": [
          {
  ...
  "104-4-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the highest-leverage follow-up to shipping a capstone?",
        "options": [
          {
  ...
  "104-5-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What should the first minute of your capstone presentation be?",
        "options": [
          {
  ...
  "104-5-1": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Best peer mix",
        "scenario": "Best peer-review mix for a capstone?",
        "options": [
          {
  ...
  "104-5-2": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Scale blocker",
        "scenario": "What blocks a workflow from scaling beyond your team?",
        "options": [
          {
  ...
  "104-5-3": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Scale path",
        "scenario": "Best path to scale a working team workflow company-wide?",
        "options": [
          {
  ...
  "104-5-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which is a safer bet about AI's next 12 months?",
        "options": [
          {
  ...
  "104-5-5": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which habit best sustains long-term AI fluency?",
        "options": [
          {
  ...
  "104-5-6": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which of these is the most durable capstone skill?",
        "options": [
          {
  ...
  "201-0-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which of these is Copilot's main advantage over a general chatbot like ChatGPT.com?",
        "options": [
          {
  ...
  "201-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want a summary of a Teams meeting you just joined. Where do you look?",
        "options": [
          {
  ...
  "201-0-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You have both a personal Microsoft account and your work account signed in on your laptop. Which should you use for Copilot at work?",
        "options": [
          {
  ...
  "201-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which of these is the best first prompt for Copilot?",
        "options": [
          {
  ...
  "201-0-4": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Pick the tool",
        "scenario": "You need to draft a reply to a customer email thread. Which tool is best?",
        "options": [
          {
  ...
  "201-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which prompt produces the most useful Word draft?",
        "options": [
          {
  ...
  "201-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've been cc'd on a 20-message thread and need to reply with a position. Best Copilot move?",
        "options": [
          {
  ...
  "201-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What's the most actionable output from a Teams meeting summary?",
        "options": [
          {
  ...
  "201-1-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which produces the best PowerPoint from Copilot?",
        "options": [
          {
  ...
  "201-1-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Best way to ask Copilot to find the Q2 forecasts spreadsheet from Priya?",
        "options": [
          {
            "text": "\"Find a file.\"",
            "correct": false,
  ...
  "201-2-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're asking Copilot to draft a customer-facing announcement. Which context adds the most value?",
        "options": [
          {
  ...
  "201-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "What does typing `/` in Copilot Chat do?",
        "options": [
          {
  ...
  "201-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You've iterated 6 times and each response is marginally better than the last. What should you do?",
        "options": [
          {
  ...
  "201-2-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which task is MOST at risk of hallucination in Copilot?",
        "options": [
          {
  ...
  "201-3-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're about to paste customer medical information into Copilot. What should you do first?",
        "options": [
          {
  ...
  "201-3-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Copilot in Teams isn't generating meeting summaries, even though the button exists. What's the most likely cause?",
        "options": [
          {
  ...
  "201-3-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want to store a long password securely. Where should it go?",
        "options": [
          {
  ...
  "201-3-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Copilot just surfaced a coworker's confidential HR file in response to your prompt, which you shouldn't have had access to. What do you do?",
        "options": [
          {
  ...
  "201-3-4": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Foundation check",
        "scenario": "The single most important habit for good Copilot output is:",
        "options": [
          {
  ...
  "202-0-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Why does Copilot in Excel work better when your data is formatted as an Excel table?",
        "options": [
          {
  ...
  "202-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which question gets the cleanest response from Copilot in Excel?",
        "options": [
          {
  ...
  "202-0-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Best prompt for a conditional count?",
        "options": [
          {
            "text": "\"COUNTIF.\"",
            "correct": false,
  ...
  "202-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You inherited a spreadsheet with a scary-looking nested formula. What's the fastest way to understand it?",
        "options": [
          {
  ...
  "202-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You have a customer list with mixed capitalization, extra whitespace, and possible duplicates. Best Copilot strategy?",
        "options": [
          {
  ...
  "202-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want all renewals in Q2 2026. Best prompt?",
        "options": [
          {
            "text": "\"Renewals.\"",
            "correct": false,
  ...
  "202-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Best first ask when building a pivot with Copilot?",
        "options": [
          {
  ...
  "202-1-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which chart prompt produces the most useful result?",
        "options": [
          {
  ...
  "202-2-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which task is best suited to a Copilot + Power Query workflow?",
        "options": [
          {
  ...
  "202-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want \"for each customer, their most recent order amount.\" What's the best Copilot approach?",
        "options": [
          {
  ...
  "202-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need the total revenue for Q2. Safest Copilot approach?",
        "options": [
          {
  ...
  "202-2-3": {
    ...
    "steps": [
      ...
      },
      {
        "type": "apply",
        "title": "Foundation check",
        "scenario": "The single most important habit from this course:",
        "options": [
          {
  ...
  "203-0-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're deciding between ChatGPT and Gemini for the same task. When does Gemini have the clearest edge?",
        "options": [
          {
  ...
  "203-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You're reading a long strategy doc in Google Docs and want a quick summary. Where's the fastest path?",
        "options": [
          {
  ...
  "203-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want Gemini to help write a thank-you note. Which prompt works better?",
        "options": [
          {
  ...
  "203-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You have 47 unread emails from a week off. Which use of Gemini gets you back up to speed fastest?",
        "options": [
          {
  ...
  "203-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want the new memo to read like a previous one your CEO wrote. Best approach?",
        "options": [
          {
  ...
  "203-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need a 10-slide board update by Friday. Smartest use of Gemini?",
        "options": [
          {
  ...
  "203-1-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Gemini generated a 2-page summary of your client call. What do you do before sending it out?",
        "options": [
          {
  ...
  "203-1-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You remember a doc from 'a few weeks ago about vendor pricing' but can't remember the title. What works best?",
        "options": [
          {
  ...
  "203-2-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want Gemini to write a client update based on yesterday's meeting notes doc. Best phrasing?",
        "options": [
          {
  ...
  "203-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "A vendor emailed you a scanned PDF invoice. You need the vendor name, total, and due date in a spreadsheet row. Best approach?",
        "options": [
          {
  ...
  "203-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Gemini's first draft is close but the tone is too stiff. Best next move?",
        "options": [
          {
            "text": "Give up and write it yourself.",
            "correct": false,
  ...
  "203-2-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Task: 'Research three competitors we don't have internal notes on and summarize their positioning.' Best tool?",
        "options": [
          {
            "text": "Always Gemini.",
            "correct": false,
  ...
  "203-2-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Gemini gives you these three pieces of information. Which should you verify before using?",
        "options": [
          {
  ...
  "203-3-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want Gemini to help you plan talking points for a client call about their renewal. Which account do you use?",
        "options": [
          {
  ...
  "203-3-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You try to @-reference a Drive file in a Gemini prompt but the @ picker shows nothing. What's the most likely reason?",
        "options": [
          {
  ...
  "203-3-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Which of these is safe to paste into personal (non-Workspace) Gemini for help?",
        "options": [
          {
  ...
  "203-3-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Gemini just returned someone else's meeting notes when you asked about your own. What do you do first?",
        "options": [
          {
  ...
  "203-3-4": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "If you had to tell a coworker the single most useful thing from this course, it would be:",
        "options": [
          {
  ...
  "204-0-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You want to generate a SUMIFS formula to total revenue for a specific region. Best starting point?",
        "options": [
          {
  ...
  "204-0-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You have a 500-row sales sheet with columns for rep, region, deal size, and close date. You want top performers. Best ask?",
        "options": [
          {
  ...
  "204-0-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need to stand up a new quarterly OKR tracker today. Best use of Gemini?",
        "options": [
          {
  ...
  "204-0-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Gemini generates a QUERY formula that looks complicated but returns the right answer on the sample data. What now?",
        "options": [
          {
  ...
  "204-1-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your raw column has inconsistent date formats. You ask Gemini to standardize. Where should the clean version go?",
        "options": [
          {
  ...
  "204-1-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need to answer: 'Which enterprise accounts in EMEA had an NPS score over 8 AND were flagged for expansion in Q2?' Best use of Gemini?",
        "options": [
          {
  ...
  "204-1-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your pivot is 90% right but you want to change the column-grouping from month to quarter. Best next move?",
        "options": [
          {
  ...
  "204-1-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You asked for a trend chart; Gemini produced a column chart. Best next move?",
        "options": [
          {
  ...
  "204-2-0": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "Your team manually copies 'closed' deals to an archive tab every week. Best use of Gemini + Apps Script?",
        "options": [
          {
  ...
  "204-2-1": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You need a formula that pulls the email-domain from each row's email column (e.g. 'acme.com' from 'alice@acme.com'). Best approach?",
        "options": [
          {
  ...
  "204-2-2": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "You asked Gemini for Q3 pipeline totals. Which response do you trust more?",
        "options": [
          {
  ...
  "204-2-3": {
    ...
    "steps": [
      ...
      },
      {
        ...
        "scenario": "If you could make your team adopt one discipline from this course, which matters most?",
        "options": [
          {
